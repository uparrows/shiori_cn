    ...
    <div id="login-box">
        <form @submit.prevent="login">
            <div id="logo-area">
                ...
                <p id="tagline">简单书签管理器</p>
            </div>
            <div id="input-area">
                <label for="username">用户名: </label>
                <input id="username" type="text" name="username" placeholder="用户名" tabindex="1" autofocus />
                ...
                <label class="checkbox-field"><input type="checkbox" name="remember" v-model="remember"
                        tabindex="3">记住我</label>
            </div>
            <div id="button-area">
                <a v-if="loading">
                    <i class="fas fa-fw fa-spinner fa-spin"></i>
                </a>
                <a v-else class="button" tabindex="4" @click="login" @keyup.enter="login">登入</a>
            </div>
        </form>
    </div>
</div>
